...
<template>
  <div style="height: calc(100vh - 160px)" class="m-auto max-w-[1400px] w-[100%] flex flex-col items-center justify-around md:flex-row">
    <div class="flex flex-col items-start justify-start md:items-start md:justify-start">
      ...
      <h1 class="mt-5 flex flex-row text-6xl font-bold">
        <span class="mr-2">I'm</span>
        <span class="text-violet" style="font-family: 'MyFont', sans-serif;">violet</span>
      </h1>
      ...
      <div class="flex flex-row">
        <a
          ...
          target="_blank"
        >
          <div :class="l.icon" class="scale-120 hover:scale-125" />
          <span class="ml-1">
            {{ l.name }}
          </span>
        </a>
